...
export class Game {
    ...
    debug(){
        this.arr[19][0].setBloackData(true, "#007bff");
        this.arr[19][1].setBloackData(true, "#007bff");
        this.arr[19][2].setBloackData(true, "#007bff");
        this.arr[19][3].setBloackData(true, "#007bff");
